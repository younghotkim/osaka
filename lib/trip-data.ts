...
export const tripDays: TripDay[] = [
  {
    day: 1,
    date: "7/2 목",
    title: "도착 → 도톤보리 네온 나이트",
    mood: "간사이 도착 → 미나미 베이스캠프 → 첫 밤은 네온 불빛 아래",
    summary:
...
export const tripStops: TripStop[] = [
  ...
  },
  {
    ...
    lng: 135.5026,
    highlights: [
      "1바퀴 15분 — 도톤보리 네온을 위에서 내려다보기",
      "¥600/인 — 돈키 쇼핑이랑 묶어서",
      "피곤하면 패스하고 강변 산책으로 대체"
    ],
    prompt: "관람차에서 내려다본 네온 한 컷.",
  ...
  },
  {
    ...
    prompt: "우메다 야경 vs 도톤보리 네온 — 어느 밤이 더 좋았는지.",
...
export const flexModes = [
  ...
  },
  {
    id: "tired",
    title: "피곤한 날",
    description: "선택/후보 일정을 숨기고 호텔 30분 낮잠 — 밤 일정(네온·야경)이 이 여행의 핵심이니 밤에 베팅."
  },
  {
    id: "usj",
    title: "USJ가 끌리는 날",
