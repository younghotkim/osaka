...
export async function fetchWeather(
  ...
  try {
    const url = `https://api.open-meteo.com/v1/forecast?latitude=${lat}&longitude=${lng}&hourly=temperature_2m,precipitation_probability,weather_code&daily=temperature_2m_min,temperature_2m_max,precipitation_probability_max,weather_code&timezone=Asia%2FTokyo&forecast_days=7`;
