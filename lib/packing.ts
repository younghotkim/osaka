...
// 오사카 7월(한여름 30℃+·매우 습함·소나기 가능) 2인 여행 기준 기본 체크리스트.
const PRESET: Array<{ label: string; category: PackCategory }> = [
  ...
  { label: "ICOCA — 현지 역에서 구매 (또는 기존 카드 챙기기)", category: "money" },
  ...
  { label: "반팔·시원한 옷 (7월 오사카 낮 30~34℃)", category: "clothes" },
  { label: "얇은 겉옷 1벌 (실내 냉방 — 전철·백화점 추움)", category: "clothes" },
  { label: "편한 운동화 (많이 걸음)", category: "clothes" },
  { label: "샌들 / 슬리퍼", category: "clothes" },
  { label: "속옷·양말 (일수+여유분 — 땀 갈아입을 여분)", category: "clothes" },
  { label: "잠옷", category: "clothes" },
  { label: "접이식 우산 (장마 끝물 소나기)", category: "clothes" },
  { label: "선글라스 · 모자 (한낮 야외 필수)", category: "clothes" },
  { label: "야경·저녁용 옷 한 벌 (공중정원 데이트룩)", category: "clothes" },
  { label: "휴대용 선풍기 / 쿨토시", category: "clothes" },
  { label: "칫솔·치약", category: "toiletries" },
  { label: "선크림 (7월 자외선 최강 — 수시로 덧바르기)", category: "toiletries" },
  { label: "땀 닦는 시트 (비오레 등 — 현지 구매도 OK)", category: "toiletries" },
